/* fastlane_esp.c: Driver for Phase5's Fastlane SCSI
 *
...
static int dma_can_transfer(struct Sparc_ESP *esp, Scsi_Cmnd *sp)
{
	/* I don't think there's any limit on the FastlaneDMA. So we use what
...
Scsi_Host_Template driver_template = SCSI_FASTLANE_ESP;
