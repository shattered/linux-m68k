/* fastlane_esp.h: Defines and structures for the Fastlane SCSI driver.
 *
...
#ifndef FASTLANE_ESP_H
#define FASTLANE_ESP_H
...
/* int release(struct Scsi_Host *) */                          fastlane_esp_release,   \
