 ...
 * range of computers.
 *
 * This code is (C) 1997 Chris Sumner (chris@ganymede.sonnet.co.uk)
...
#define uart ((*(volatile struct uart_16c550 *)(zTwoBase + WHIPPET_PHYSADDR)))

#define ser_DTRon  uart.MCR |=  DTR
#define ser_RTSon  uart.MCR |=  RTS
#define ser_DTRoff uart.MCR &= ~DTR
#define ser_RTSoff uart.MCR &= ~RTS

#define GAYLE_IRQ_STATUS ((unsigned char *)ZTWO_VADDR(0xDA9000))
#define GAYLE_IRQ_STATUS2 ((unsigned char *)ZTWO_VADDR(0xDA8000))
