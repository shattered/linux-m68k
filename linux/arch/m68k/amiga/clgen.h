...
#define SRX	0x3c4	/* Sequencer Index */
#define SR0	0x0	/* Reset */
#define SR1     0x1	/* Clocking Mode */
#define SR2	0x2	/* Plane Mask / Write Pixel Extension */
#define SR3	0x3	/* Character Map Select */
#define SR4	0x4	/* Memory Mode */
/* the following are from the "extension registers" group */
#define SR6	0x6	/* Unlock ALL Extensions */
#define SR7	0x7	/* Extended Sequencer Mode */
#define SR8	0x8	/* EEPROM Control */
#define SR9	0x9	/* Scratch Pad 0 (do not access!) */
#define SRA	0xa	/* Scratch Pad 1 (do not access!) */
#define SRB	0xb	/* VCLK0 Numerator */
#define SRC	0xc	/* VCLK1 Numerator */
#define SRD	0xd	/* VCLK2 Numerator */
#define SRE	0xe	/* VCLK3 Numerator */
#define SRF	0xf	/* DRAM Control */
#define SR10	0x10	/* Graphics Cursor X Position */
#define SR11	0x11	/* Graphics Cursor Y Position */
#define SR12	0x12	/* Graphics Cursor Attributes */
#define SR13	0x13	/* Graphics Cursor Pattern Address Offset */
#define SR14	0x14	/* Scratch Pad 2 (CL-GD5426/'28 Only) (do not access!) */
#define SR15	0x15	/* Scratch Pad 3 (CL-GD5426/'28 Only) (do not access!) */
#define SR16	0x16	/* Performance Tuning (CL-GD5424/'26/'28 Only) */
#define SR17	0x17	/* Configuration ReadBack and Extended Control (CL-GF5428 Only) */
#define SR18	0x18	/* Signature Generator Control (Not CL-GD5420) */
#define SR19	0x19	/* Signature Generator Result Low Byte (Not CL-GD5420) */
#define SR1A	0x1a	/* Signature Generator Result High Byte (Not CL-GD5420) */
#define SR1B	0x1b	/* VCLK0 Denominator and Post-Scalar Value */
#define SR1C	0x1c	/* VCLK1 Denominator and Post-Scalar Value */
#define SR1D	0x1d	/* VCLK2 Denominator and Post-Scalar Value */
#define SR1E	0x1e	/* VCLK3 Denominator and Post-Scalar Value */
#define SR1F	0x1f	/* BIOS ROM write enable and MCLK Select */
